  ...
  <div id = "main">
    <div class = "title_container">
      <div class = "text_box">
        ...
        <div class = "each_text"><a href ="./fourth_divide.jsp" target ="_top"><p class = "title_font">기타분류 설정</p></a></div>
      </div>
    </div>
    <div class = "list_container">
      <div class = "category_select_area">
        ...
        <div class = "each_select_box">
          <button id = "third_divide_select"><span>소분류 선택</span></button>
          <div class="toggle_box">
            <div class="toggle_content">소분류 옵션1</div>
            <div class="toggle_content">소분류 옵션2</div>
            <div class="toggle_content">소분류 옵션3</div>
            <div class="toggle_content">소분류 옵션4</div>
            <div class="toggle_content">소분류 옵션5</div>
            <div class="toggle_content">소분류 옵션6</div>
            <div class="toggle_content">소분류 옵션7</div>
            <div class="toggle_content">소분류 옵션8</div>
            <div class="toggle_content">소분류 옵션9</div>
          </div>
        </div>
      </div>
          ...
          <div class = "table_container">
            <div class = "tr_container" style = "font-weight : bold;">
              <div class = "td_container">
                ...
                <div class = "td_cell gray">기타분류</div>
            ...
            <div class = "tr_container">
              <div class = "td_container">
                ...
                <div class = "td_cell">기타분류 예시 0</div>
            ...
            <div class = "tr_container">
              <div class = "td_container">
                ...
                <div class = "td_cell">기타분류 예시 1</div>
                <div class = "td_cell_small">$101.01</div>
                <div class = "td_cell_small">$102.02</div>
                <div class = "td_cell_small">$103.03</div>
              </div>
